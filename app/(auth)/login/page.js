...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    router.push(profile?.username ? '/feed' : '/setup-profile')
    router.refresh()
  }
    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        <div className={styles.card}>
          ...
          <p className={styles.sub}>The quiet ones missed you.</p>
          ...
          <div className={styles.fields}>
            ...
            <div className={styles.fieldGroup}>
              <div className={styles.labelRow}>
                ...
                <Link href="/reset-password" className={styles.forgot}>Forgot?</Link>
              </div>
              <input
                className={styles.input}
                type="password"
          ...
          <button className={styles.submit} onClick={handleLogin} disabled={loading}>
            {loading ? 'Entering…' : 'Enter Strangr'}
          </button>
