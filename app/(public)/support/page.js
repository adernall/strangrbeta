  ...
  return (
    <div style={{minHeight:'100vh',background:'#0e0e0e',color:'#e8e2d9',display:'flex',flexDirection:'column'}}>
      ...
      <main style={{flex:1,maxWidth:'680px',margin:'0 auto',padding:'80px 32px',width:'100%'}}>
        <p style={{fontSize:'11px',letterSpacing:'0.12em',color:'#6b6560',textTransform:'uppercase',marginBottom:'24px'}}>/ support</p>
        <h1 style={{fontFamily:'Space Grotesk,sans-serif',fontSize:'48px',fontWeight:700,letterSpacing:'-0.025em',marginBottom:'16px'}}>Support</h1>
        <p style={{fontSize:'16px',color:'#6b6560',lineHeight:1.7,marginBottom:'48px'}}>Having trouble? We're here — quietly.</p>
